...
% ======================================================================
% This is the training (Gaussian denoising) demo of the paper "Beyond a Gaussian Denoiser: Residual Learning of Deep CNN for Image Denoising"
...
----Train400 (400 training images of size 180X180, large training data is preferred!!!)
----utilities 
----GenerateTrainingPatches.m (run this to generate training (clean) patches!)
